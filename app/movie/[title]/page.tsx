	...
	awards: [
		{
			...
			for: 'Motion Picture',
			image: 'https://m.media-amazon.com/images/M/MV5BZjhhMThhNDItNTY2MC00MmU1LTliNDEtNDdhZjdlNTY5ZDQ1XkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_Ratio0.6757_AL_.jpg',
		},
		{
			title: '2019 Winner OFTA Film Hall of Fame',
			for: 'Motion Picture',
...
export default function MoviePage() {
	return (
		<div className="md:mt-36 items-center flex justify-center min-h-screen flex-col md:flex-row">
			...
			<div className="flex flex-col w-full md:w-1/2 md:items-center space-y-4">
